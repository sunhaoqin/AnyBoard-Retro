...
#else       /*LV_MEM_CUSTOM*/
#  define LV_MEM_CUSTOM_INCLUDE "ab_mem.h"   /*Header for the dynamic memory function*/
#  define LV_MEM_CUSTOM_ALLOC   ab_malloc       /*Wrapper to malloc*/
#  define LV_MEM_CUSTOM_FREE    ab_free         /*Wrapper to free*/
#endif     /*LV_MEM_CUSTOM*/
